...
for v in verify_stage1 verify_stage2 verify_stage2b verify_stage3 verify_stream \
         ...
         verify_trail verify_objtags verify_floor verify_sayto verify_saykind verify_give verify_bond verify_compose verify_approach verify_action_system verify_reactions verify_use \
