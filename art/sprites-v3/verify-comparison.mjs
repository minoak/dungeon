...
try {
 ...
 await page.goto('file:///'+root+'/walk-comparison.html');
 await page.waitForFunction(()=>ready===2);
 ...
 await page.screenshot({path:root+'/walk-comparison-preview.png',fullPage:true});
 await page.setViewportSize({width:390,height:844});assert.equal(await page.evaluate(()=>document.documentElement.scrollWidth<=innerWidth),true);
 assert.deepEqual(errors,[]);console.log('PASS: both strips, 4 frames, pause/resume, mobile width, no page errors');
