...
if launcher is None:
    ...
    check("⑥ 맵 concept: DUNGEON_ARCH=concept · 크기 54x42 를 같이 준다(부모 env 의 40x16 을 덮는다)",
          e_con.get("DUNGEON_ARCH") == "concept" and (e_con.get("DUNGEON_W"), e_con.get("DUNGEON_H")) == ("54", "42"))
